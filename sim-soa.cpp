...
int main(int argc, const char ** argcv){
    ...
    int a = argc;
    cout<< "me cago en la p madr"<< a <<endl;
    // parameters init & casting
    num_objects = atoi(argcv[2]);
    num_iterations = atoi(argcv[3]);
    random_seed = atoi(argcv[4]);
    size_enclosure = atoi(argcv[5]);
    time_step = atoi(argcv[6]);
    ...
    // darle cosas al bang
    universe->px = (double *)malloc(sizeof(double)*num_objects);
    universe->py =  (double *)malloc(sizeof(double)*num_objects);
    universe->pz = (double *)malloc(sizeof(double)*num_objects);
    universe->vx = (double *)malloc(sizeof(double)*num_objects);
    universe->vy = (double *)malloc(sizeof(double)*num_objects);
    universe->vz = (double *)malloc(sizeof(double)*num_objects);
    universe->m = (double *)malloc(sizeof(double)*num_objects);
    universe->ax = (double *)malloc(sizeof(double)*num_objects);
    universe->ay = (double *)malloc(sizeof(double)*num_objects);
    universe->az = (double *)malloc(sizeof(double)*num_objects);
    //universe = new Universe(num_objects, size_enclosure);
    universe->size = size_enclosure;
    universe->objects = num_objects;
    ...
    for (int i = 0; i < num_objects; i++){
        ...
        cout<<"universei: "<<universe->m[i]<< "dmierda"<<d(gen64)<< endl;
    ...
    bool *deleted = new bool[num_objects];  // bytemap of objects -> if true, object is deleted
